...
public class UaoanStandardVideoController extends GestureVideoController implements View.OnClickListener {
    ...
    public UaoanStandardVideoController(@NonNull Context context, VideoView player) {
        this(context,player,null);
        videoView=player;
    }

    public UaoanStandardVideoController(@NonNull Context context, VideoView player, @Nullable AttributeSet attrs) {
        this(context,player, attrs, 0);
        videoView=player;
    }

    public UaoanStandardVideoController(@NonNull Context context, VideoView player, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void newLayoutSpeed(){
        layoutSpeed=View.inflate(getContext(),R.layout.dkplayer_layout_gesture_control_view,null);
        ...
        textView.setText(DkPlayerView.getLongSpeeds()+"X倍速播放中...");
    ...
    public void onLongPress(MotionEvent e) {
        ...
        //onspeed.onSpeed();
        newLayoutSpeed();
        videoView.setSpeed(DkPlayerView.getLongSpeeds());
        addView(layoutSpeed);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                videoView.setSpeed(DkPlayerView.getSpeeds());
    ...
    //显示隐藏底部进度条
    public void setBottomProgress(boolean visibility){
        VodControlView.setBottomProgress(visibility);
    }
